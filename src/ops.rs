...
/// broadcasting case docs/numpy-interface-subset.md's table names alongside plain same-shape
...
impl RustArray {
    ...
    /// See docs/rust-array-core.md's "PR 3": not required for correctness (Python falls back to
