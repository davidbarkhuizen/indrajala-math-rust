"""
docs/relu-array-layer.md stage 2: array_relu/array_relu_mask, this crate's first genuinely new
ufunc since np.maximum/np.where were named as deferred in docs/numpy-interface-subset.md's
