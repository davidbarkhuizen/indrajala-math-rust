"""
docs/dropout-array-layer.md's Rust-matmul-backed follow-on: layer_dropout_forward/
...
docs/rust-array-core.md already documents for uniform()), and here the mask *is* the mechanism
